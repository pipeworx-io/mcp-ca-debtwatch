...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/ca_debt_search_issues \
  -H 'Content-Type: application/json' \
  -d '{"issuer":"Los Angeles Unified School District","limit":5}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/ca_debt_search_issues`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
